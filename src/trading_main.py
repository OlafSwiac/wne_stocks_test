...
strategy = {'each_3_months': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2,
                        'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                        'file': 'results_csv/each_3_months.csv', 'stocks': stock_dict['second_IR_2'], 'change': 3},
            'each_month': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2,
                        'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                        'file': 'results_csv/each_month.csv', 'stocks': stock_dict['second_IR_2'], 'change': 1},
            'each_4_months': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2,
                        'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                        'file': 'results_csv/each_4_months.csv', 'stocks': stock_dict['second_IR_2'], 'change': 4},
            'default': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2,
                        'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                        'file': 'results_csv/default.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'tc_0005': {'tc': 0.0005, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2,
                        'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                        'file': 'results_csv/tc_005.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'tc_001': {'tc': 0.001, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2,
                       'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                       'file': 'results_csv/tc_001.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'tc_0': {'tc': 0, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2,
                     'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                     'file': 'results_csv/tc_0.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'sl_l_3': {'tc': 0.00075, 'sl_long': 0.03, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2,
                       'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                       'file': 'results_csv/sl_l_3.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'sl_l_5': {'tc': 0.00075, 'sl_long': 0.05, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2,
                       'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                       'file': 'results_csv/sl_l_5.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'no_sl': {'tc': 0.00075, 'sl_long': 10000, 'sl_short': 10000, 'kelly': 'f1', 'vg': 2,
                      'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                      'file': 'results_csv/no_sl.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'kelly_f2': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f2', 'vg': 2,
                         'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                         'file': 'results_csv/kelly_f2.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'kelly_f3': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f3', 'vg': 2,
                         'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                         'file': 'results_csv/kelly_f3.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'vg_1.5': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 1.5,
                       'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                       'file': 'results_csv/vg_1.5.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'vg_2.5': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2.5,
                       'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                       'file': 'results_csv/vg_2.5.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'no_vg': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 10000,
                      'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                      'file': 'results_csv/no_vg.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'best_IR_2': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2,
                          ...
                          'file': 'results_csv/best_IR_2.csv', 'stocks': stock_dict['IR_2'], 'change': 2},
            'second_ASD': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2,
                           ...
                           'file': 'results_csv/second_ASD.csv', 'stocks': stock_dict['ASD'], 'change': 2},
            'sl_s_05': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.005, 'kelly': 'f1', 'vg': 2,
                        'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                        'file': 'results_csv/sl_s_05.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            'sl_s_15': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.015, 'kelly': 'f1', 'vg': 2,
                        'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
                        'file': 'results_csv/sl_s_15.csv', 'stocks': stock_dict['second_IR_2'], 'change': 2},
            }

generate_list_of_stocks = False
...
strategy = {'second_ASD': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.01, 'kelly': 'f1', 'vg': 2,
                           'metrics': 'Stock_lists/new_stocks_test_15_second_best_ASD_2005_train.json',
                           'file': 'results_csv/second_ASD.csv', 'stocks': stock_dict['ASD'], 'change': 2},
            'sl_s_05': {'tc': 0.00075, 'sl_long': 0.04, 'sl_short': 0.005, 'kelly': 'f1', 'vg': 2,
                        'metrics': 'Stock_lists/new_stocks_test_15_second_best_IR_2_2005_train.json',
...
for key, parameters in strategy.items():
    Results[key] = trade.initialize_trading(parameters, generate_list_of_stocks)
    ...
    predictions[key] = predictions[key][predictions[key].index < datetime.datetime(2023, 7, 1)]
