...
stock_list = []
for i in range(16):
    start_day = datetime.datetime(2007, 12, 1) - datetime.timedelta(days=30 * 3 * i)
    ...
    best_investment = list(investment_back_sorted)[-11: -1]
    print(best_investment)
    stock_list += best_investment

print(set(stock_list))