...
def initialize_trading(stocks_symbols: list):
    ...
    initial_data = TradingAlgorithmEnvironment(stocks_symbols,
                                               initial_time=datetime.datetime(2008, 1, 1),
                                               ...
                                               daily_balances=[],
                                               stocks_file='Stock_lists/new_stocks_test_30_2008_train.json')
    ...
    validation_portfolios = opt.get_validation_portfolios(stocks_start=stocks_symbols,
                                                          ...
                                                          periods=periods,
                                                          initial_date=datetime.datetime(2008, 1, 1))
    ...
    """with open("Stock_lists/new_stocks_test_30_2008_train.json", "w") as fp:
